...
const LinkButton = ({ type = 'filled', authType, title }: LinkButtonProps) => {
  ...
  return (
    <Link
      ...
      className={`xl:text-md font-semibold  rounded-xl px-6 sm:px-12 lg:px-10 xl:px-12 py-2 sm:py-3 text-white cursor-pointer
    ${
      type === 'filled'
        ? 'hover:from-indigo-700 hover:to-indigo-950 bg-gradient-to-r from-indigo-950 to-indigo-700'
